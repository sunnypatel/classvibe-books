...
<!--
    ...
    <script type="text/javascript" src="<?php echo base_url('assets/js/metro/carousel.js')?>"></script>
    <script type="text/javascript" src="<?php echo base_url('assets/js/metro/input-control.js')?>"></script>
    <script type="text/javascript" src="<?php echo base_url('assets/js/metro/pagecontrol.js')?>"></script>
